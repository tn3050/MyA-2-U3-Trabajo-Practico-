...
void Game::InitPhysics()
{
	...
	//Objeto estatico
	b2Body* Square = Box2DHelper::CreateRectangularStaticBody(phyWorld, 10,10);
	Square->SetTransform(b2Vec2(50.0f, 25.0f), 0.0f);
	...
	Box2DHelper::CreateDistanceJoint(phyWorld, circuloIzq, circuloIzq->GetWorldCenter(),
		Square, Square->GetWorldCenter(), 20.0f, 0.1f, 1.0f);
